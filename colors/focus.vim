...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#222421', '#d7005f', '#00af5f', '#d78700', '#0087d7', '#d787d7', '#00afaf', '#dadada', '#707070', '#ff005f', '#00d75f', '#ffaf00', '#5fafff', '#ff87ff', '#00d7d7', '#ffffff']
  endif
  hi Normal guifg=#dadada guibg=#222421 gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#1c1c1c gui=NONE cterm=NONE
  hi Conceal guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi CurSearch guifg=#ff5fff guibg=#222421 gui=reverse cterm=reverse
  hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi CursorColumn guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi CursorLineNr guifg=#dadada guibg=#303030 gui=NONE cterm=NONE
  hi DiffAdd guifg=#00af00 guibg=#222421 gui=reverse cterm=reverse
  hi DiffChange guifg=#87afd7 guibg=#222421 gui=reverse cterm=reverse
  hi DiffDelete guifg=#d75f5f guibg=#222421 gui=reverse cterm=reverse
  hi DiffText guifg=#d787d7 guibg=#222421 gui=reverse cterm=reverse
  hi Directory guifg=#dadada guibg=NONE gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#707070 guibg=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#dadada guibg=#222421 gui=reverse cterm=reverse
  hi FoldColumn guifg=#707070 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#707070 guibg=#222421 gui=NONE cterm=NONE
  hi IncSearch guifg=#ffaf00 guibg=#222421 gui=reverse cterm=reverse
  ...
  hi Pmenu guifg=#222421 guibg=#a8a8a8 gui=NONE cterm=NONE
  hi PmenuMatch guifg=#d7005f guibg=#a8a8a8 gui=NONE cterm=NONE
  hi PmenuExtra guifg=#222421 guibg=#a8a8a8 gui=NONE cterm=NONE
  hi PmenuKind guifg=#222421 guibg=#a8a8a8 gui=bold cterm=bold
  hi PmenuSbar guifg=#707070 guibg=#585858 gui=NONE cterm=NONE
  hi PmenuSel guifg=#222421 guibg=#dadada gui=NONE cterm=NONE
  hi PmenuMatchSel guifg=#d7005f guibg=#dadada gui=bold cterm=bold
  hi PmenuExtraSel guifg=#222421 guibg=#dadada gui=NONE cterm=NONE
  hi PmenuKindSel guifg=#222421 guibg=#dadada gui=bold cterm=bold
  hi PmenuThumb guifg=#dadada guibg=#dadada gui=NONE cterm=NONE
  hi Question guifg=#dadada guibg=NONE gui=NONE cterm=NONE
  hi QuickFixLine guifg=#ff5fff guibg=#222421 gui=reverse cterm=reverse
  hi Search guifg=#00afff guibg=#222421 gui=reverse cterm=reverse
  ...
  hi StatusLine guifg=#222421 guibg=#dadada gui=bold cterm=bold
  hi StatusLineNC guifg=#707070 guibg=#222421 gui=reverse cterm=reverse
  hi TabLine guifg=#707070 guibg=#222421 gui=reverse cterm=reverse
  hi TabLineFill guifg=#dadada guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#222421 guibg=#dadada gui=bold cterm=bold
  hi Title guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi VertSplit guifg=#707070 guibg=#222421 gui=NONE cterm=NONE
  hi Visual guifg=#ffaf00 guibg=#222421 gui=reverse cterm=reverse
  hi VisualNOS guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi WarningMsg guifg=#dadada guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#00afff guibg=#222421 gui=bold cterm=bold
  hi Comment guifg=#707070 guibg=NONE gui=bold cterm=bold
  hi Constant guifg=#dadada guibg=NONE gui=NONE cterm=NONE
  hi Error guifg=#ff005f guibg=#222421 gui=bold,reverse cterm=bold,reverse
  ...
  hi CursorIM guifg=#222421 guibg=#afff00 gui=NONE cterm=NONE
  hi ToolbarLine guifg=NONE guibg=#222421 gui=NONE cterm=NONE
  hi ToolbarButton guifg=#dadada guibg=#222421 gui=bold cterm=bold
else
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
